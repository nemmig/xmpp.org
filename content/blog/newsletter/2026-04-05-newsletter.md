...
- [Falkon Connect](https://invent.kde.org/yowhatsup/falkon/-/blob/xmpp-chat/src/scripts/webxdc/readme.md), an XMPP extension for the [KDE](https://kde.org/)'s [Falkon web browser](https://www.falkon.org/). Built using Python and [Slixmpp](https://codeberg.org/poezio/slixmpp/src/branch/master/README.rst), it integrates a chat client directly into the browser's sidebar as a widget. This initial version includes support for [WebXDC](https://webxdc.org/) applications, [XEP-0363](/extensions/xep-0363.html) (HTTP File Upload), [XEP-0280](/extensions/xep-0280.html) (Message Carbons), [XEP-0308](/extensions/xep-0308.html) (Last Message Correction), and [XEP-0444](/extensions/xep-0444.html) (Message Reactions) emoji reactions.

{{< figure src="/images/newsletter/2026-04-05/Falkon-Connect.png" caption="Falkon-Connect" >}}
